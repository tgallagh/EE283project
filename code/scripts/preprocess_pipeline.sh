...
#### Pipeline for quality filtering and aligning P1 RNAseq data
...
ref=/bio/tgallagh/EE283/EE283_final/data/processed/genome
...
#mkdir /bio/tgallagh/EE283/EE283_final/data/raw/bowtie2
#RAWDEST=/bio/tgallagh/EE283/EE283_final/data/raw/bowtie2/

#bowtie2 --very-fast -x $ref/P1index -1 $input\READ1.fastq -2 $input\READ2.fastq  -S $RAWDEST$input\_raw.sam
#samtools view -bS $RAWDEST$input\_raw.sam | samtools sort > $RAWDEST$input\_raw.sorted.bam
...
#ADAPTORS=/bio/tgallagh/EE283/EE283_final/data/raw/adaptors/

#mkdir /bio/tgallagh/EE283/EE283_final/data/processed/trimmed 
...
#perl /bio/tgallagh/programs/deconseq/deconseq.pl -dbs P1_FLR01_A5_rRNA -f $TRIMMED$input\READ1_READ2_cat_unpaired2.fasta -i 95 -c 90 -o  $TRIMMED$input\READ1_READ2_cat_unpaired2.fasta.deconseq
#perl /bio/tgallagh/programs/deconseq/deconseq.pl -dbs P1_FLR01_A5_rRNA -f $TRIMMED$input\READ1_READ2_merged.fastq.unassembled.reverse.fasta  -i 95 -c 90 -o $TRIMMED$input\READ1_READ2_merged.fastq.unassembled.reverse.fasta.deconseq
#perl /bio/tgallagh/programs/deconseq/deconseq.pl -dbs P1_FLR01_A5_rRNA -f $TRIMMED$input\READ1_READ2_merged.fastq.unassembled.forward.fasta -i 95 -c 90 -o  $TRIMMED$input\READ1_READ2_merged.fastq.unassembled.forward.fasta.deconseq
...
#mkdir /bio/tgallagh/EE283/EE283_final/data/processed/bowtie2
ALIGN=/bio/tgallagh/EE283/EE283_final/data/processed/bowtie2/
#bowtie2 -D 20 -R 3 -N 0 -L 20 -i S,1,0.50 -I 0 --no-unal -f -x$ref/P1index \
...
HTSEQ=/bio/tgallagh/EE283/EE283_final/data/processed/htseq/
#cd /bio/tgallagh/programs/HTSeq-0.6.1/scripts
#samtools view $ALIGN$input\singles.sorted.bam | ./htseq-count -s no -t CDS -i ID - /bio/tgallagh/EE283/EE283_final/data/processed/genome/FLR01.gff > $HTSEQ$input\singles.xls
#samtools view $ALIGN$input\both.sorted.bam | ./htseq-count -s no -t CDS -i ID - /bio/tgallagh/EE283/EE283_final/data/processed/genome/FLR01.gff > $HTSEQ$input\both.xls
...
#### Did these next commands in shell
...
#########################################################
bedtools genomecov -ibam $ALIGN$input\singles.sorted.bam -g /bio/tgallagh/EE283/EE283_final/data/processed/genome/FLR01.genome -d > $ALIGN$input\singles.sorted.coverage.txt
bedtools genomecov -ibam $ALIGN$input\both.sorted.bam -g /bio/tgallagh/EE283/EE283_final/data/processed/genome/FLR01.genome -d > $ALIGN$input\both.sorted.coverage.txt
...
#mkdir /bio/tgallagh/EE283/EE283_final/data/processed/bowtie2/coverage
COV=/bio/tgallagh/EE283/EE283_final/data/processed/bowtie2/coverage/
